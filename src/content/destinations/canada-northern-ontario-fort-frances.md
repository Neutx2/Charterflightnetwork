---
title: "Fort Frances Charter Flights - 3 Competitive Quotes"
description: "Fort Frances Wheel Plane / Float Plane Charter Flights To Remote Fly-In Fishing To Lodges and Outpost Camps. Receive 3 Competitive Quotes."
legacyUrl: "/fort_frances_charter_flights.htm"
slug: "canada/northern-ontario/fort-frances"
thin: false
quoteSubject: "Fort Frances Charter"
region: "canada"
province: "Northern Ontario"
provinceSlug: "northern-ontario"
city: "Fort Frances"
---
Charter Flights To Fort Frances

### [Charter Flights To Fort Frances](#collapseOne1)

Click The Above Title To Hide This Text Window

### Location

Located just across the Border from International Falls Minnesota, Fort Frances' proximity to the US market makes it a very popular jumping off point for wilderness trips to the north. You can book a variety of charter flights out of Fort Frances including float planes and wheel planes to remote outpost camps and fly-in fishing lodges. If you are traveling from the USA, you will find that International Falls, Mn is served by a Delta Airlines feeder airline with direct connections out of Minneapolis.

### Fort Frances Airport

The Fort Frances Airport is located 2.5 miles northwest of town and has 4,493 foot asphalt runway

In addition to their main float plane air base in Fort Frances, Rusty Myers also operates a satellite float plane base at Savant Lake which is located on hwy 599 north of Ignace. This is a popular departure point for groups who don't mind the extra drive in order to start their fly-in vacation from this far northern base. Use our Charter Quote Request Service for price quotes.
...
## Fort Frances Wheel Plane Charter Flights

One of our most popular requests is for direct charter flights from Chicago, Minneapolis and other US departure points to Fort Frances, Ontario. Upon arrival in Fort Frances, passenges then connect with float plane for an exceptional fly-in fishing adventure. Let us know if we can source out flight quotes for your group.

## Fort Frances Float Plane Charter Flights

There are several options for float plane charter flights out of Fort Frances. The charter services here all specialize in setting up fly-in fishing trips to remote lodges and outpost camps throughout Northwestern Ontario and beyond.

## Fort Frances Helicopter Charter Flights

There are no full time helicopter charter airlines based in Fort Frances. If a helicopter charter is what you need, let us know the details and dates. We will then source out to all companies in the region for competiitve helicopter options that meet your requirements.
